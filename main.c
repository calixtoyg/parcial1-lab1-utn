...
int main() {
    ...
    */
    int menu, menuJuegos, menuClientes = 5, menuAlquileres = 5, menuInformes, flagJuegos = 0,
            flagClientes = 0, flagAlquileres = 0, idToFind, index, flagFORTESTING = 0, fechaSuccessful;
    int dia, mes, ano;
    int idJ = 0, idC = 0, idA = 0, quantityOfJ = 5, quantityOfC = 6;
    int idJuegoParaAlquiler, idClienteParaAlquiler, isAlquilerSuccesfull;
    ...
    do {
        //cambiar a 0 para hacer pruebas (arrays ya incializados)
        if (flagFORTESTING == 0) {
            flagFORTESTING = 1;
                    ...
                    switch (menuInformes) {
                        ...
                        case 3:
                            getEntero(&idToFind, "Ingrese el ID del juego del cual desea listar sus clientes\n",
                                      "ERROR: Solo numeros dentro de la cantidad maxima del array estan perimitidos\n",
                                      0, JUEGOSIZE, 3);
                            alquilerDeUnJuegoDeterminado(idToFind, alquileres, juegos, clientes, JUEGOSIZE,
                                                         CLIENTESIZE);
                        ...
                        case 4:
                            getEntero(&idToFind, "Ingrese el ID del juego del cual desea listar sus clientes\n",
                                      ...
                                      0, CLIENTESIZE, 3);
                            alquilerDeUnClienteDeterminado(idToFind, alquileres, juegos, clientes, JUEGOSIZE,
                                                           CLIENTESIZE);
                            break;
                        case 5:
                        ...
                        case 6:
                            initAlquileresVecesAlquilado(aquileresDeClientes, CLIENTESIZE);
                            fillClientesQueAlquilaron(aquileresDeClientes, clientes, alquileres, JUEGOSIZE,
                                                      CLIENTESIZE);
                            sortByClientesQueAlquilaron(aquileresDeClientes, CLIENTESIZE);
                            printClienteRealizoMasAlquileres(aquileresDeClientes, clientes, CLIENTESIZE);

                            break;
                        case 7:
                            getEntero(&dia, "Ingrese el dia:\n", "ERROR: dia invalido", 0, 31, 3);
                            printf("------------------------------------------------------------\n");
                            getEntero(&mes, "Ingrese el mes:\n", "ERROR: mes invalido", 0, 12, 3);
                            printf("------------------------------------------------------------\n");
                            getEntero(&ano, "Ingrese el año:\n", "ERROR: ano invalido", 1, 9999, 3);
                            fechaABuscarParaJuego(dia, mes, ano, alquileres, juegos, clientes, JUEGOSIZE,
                                                      CLIENTESIZE);
                            break;
                        case 8:
                            getEntero(&dia, "Ingrese el dia:\n", "ERROR: dia invalido", 0, 31, 3);
                            ...
                            printf("------------------------------------------------------------\n");
                            getEntero(&ano, "Ingrese el año:\n", "ERROR: ano invalido", 1, 9999, 3);
                            fechaABuscarParaAlquileres(dia, mes, ano, alquileres, juegos, clientes, JUEGOSIZE,
                                                  CLIENTESIZE);
                            break;
